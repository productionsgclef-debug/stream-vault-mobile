import { ScrollView, Text, View, TouchableOpacity, FlatList, Pressable, Image } from "react-native";
...
const mockContent = {
  ...
  trending: [
    ...
    { id: "3", title: "Drama Series", rating: 7.9, poster: "https://via.placeholder.com/150x225/e50914/ffffff?text=Trending+2" },
    { id: "4", title: "Sci-Fi Adventure", rating: 8.7, poster: "https://via.placeholder.com/150x225/e50914/ffffff?text=Trending+3" },
    { id: "5", title: "Comedy Special", rating: 7.5, poster: "https://via.placeholder.com/150x225/e50914/ffffff?text=Trending+4" },
    { id: "6", title: "Horror Film", rating: 8.1, poster: "https://via.placeholder.com/150x225/e50914/ffffff?text=Trending+5" },
  ],
  newReleases: [
